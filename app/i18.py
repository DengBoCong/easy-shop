lang = {
    "zh_cn": {
        ...
        "common_search_customers": "搜索客户",
        "common_search_product": "搜索产品",
        "common_shopping_customer_mode": "购物袋 - 客户模式",
        "common_sample_customer_mode": "样品袋 - 客户模式",
        "common_switch_customer_mode": "切换客户模式",
        ...
        "common_del_good_order_fail_tip": "商品存在订单数据，不允许删除！",
        "common_sure": "确认",
        "common_del_tips": "删除之后数据将不可恢复",
    ...
    "en_us": {
        ...
        "common_all_countries": "all countries",
        ...
        "common_search_customers": "search customers",
        "common_search_product": "search product",
        "common_customer_mode": "shopping bag - customer mode",
        "common_switch_customer_mode": "switch to customer mode",
        "common_shopping_customer_mode_tips": "You can stay in the customer mode to check every customer's shopping bag, or you can switch to product mode to check every product's information by clicking the button on the right.",
        "common_sample_customer_mode_tips": "You can stay in the customer mode to check every customer's sample bag, or you can switch to product mode to check every product's information by clicking the button on the right.",
        ...
        "common_del_good_order_fail_tip": "The order data exists for the product, and it is not allowed to delete it!",
        "common_sure": "make sure",
        "common_del_tips": "Data will be unrecoverable after deletion",
        ...
        "inner_add_query": "Queried successfully",
